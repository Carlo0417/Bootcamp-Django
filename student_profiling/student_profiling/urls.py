...
from simple_profiling.views import StudentList, CourseList, CollegeList, StudentUpdateView, CourseUpdateView, CollegeUpdateView
from simple_profiling import views
